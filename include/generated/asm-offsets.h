...
#define THREAD_EVR0 380 /* offsetof(struct thread_struct, evr[0])	 # */
#define THREAD_ACC 512 /* offsetof(struct thread_struct, acc)	 # */
#define THREAD_SPEFSCR 520 /* offsetof(struct thread_struct, spefscr)	 # */
#define THREAD_USED_SPE 524 /* offsetof(struct thread_struct, used_spe)	 # */
